...
export const messagesPage: DeliveryMessagesPage = {
  items: [
    {
      id: "b1a7c9d0-0000-4000-8000-000000000301",
      kind: "task_dispatch",
      subject: "T3 修复任务包已发布",
      body: "隐藏验收测试 3/9 失败，修复范围限定 src/orders/components/**，任务包已发布到共享存储。",
      sender_agent_id: "b1a7c9d0-0000-4000-8000-0000000000a1",
      sender_name: "repomesh-pricing-leader",
      recipient_agent_id: "b1a7c9d0-0000-4000-8000-0000000000a2",
      recipient_name: "dashboard-worker",
      repository_id: null,
      task_id: IDS.task.t3,
      status: "delivered",
      event_id: "$evt-repair-t3-r2",
      correlation_id: IDS.task.t3,
      created_at: "2026-08-09T10:42:00+00:00",
      direction: "leader_to_worker",
    },
    {
      id: "b1a7c9d0-0000-4000-8000-000000000302",
      kind: "task_dispatch",
      subject: "T4 任务包已发布",
      body: "示例支付 App 传递修改原因，验收命令由 Runner 受控执行。",
      sender_agent_id: "b1a7c9d0-0000-4000-8000-0000000000a1",
      sender_name: "repomesh-pricing-leader",
      recipient_agent_id: "b1a7c9d0-0000-4000-8000-0000000000a3",
      recipient_name: "apps-worker",
      repository_id: null,
      task_id: IDS.task.t4,
      status: "delivered",
      event_id: "$evt-dispatch-t4",
      correlation_id: IDS.task.t4,
      created_at: "2026-08-09T10:47:00+00:00",
      direction: "leader_to_worker",
    },
  ],
};
