...
function TeamDialog({ agents, onClose, onCreated }: { agents: AgentPrincipal[]; onClose: () => void; onCreated: (result: AgentTeamResult) => void }) {
