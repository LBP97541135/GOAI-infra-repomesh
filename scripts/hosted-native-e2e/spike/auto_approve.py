#!/usr/bin/env python3
"""Stand-in for the platform's future auto-approval:
answer copaw Tool Guard prompts for the helper script only.

Polls one room; when the member posts "Waiting for approval" whose command contains
base/tools/rm-work.sh,
replies with body "/approve" carrying m.mentions
(bare body; a textual mention prefix breaks copaw's matcher).
