...
第 9–14 项已于 2026-09-04 裁决并写回 §3（D-23、D-6、D-12、D-21、D-3），原文保留作实证依据，**不再是开放项**；第 16 项是裁决后新留的实现开放项，PR-A 施工前定。
