...
class TestBuildPrompt:
    ...
    def test_includes_candidate_list(self) -> None:
        ...
        messages = _build_confirmation_prompt(
            profile, "test", ["repo-a", "repo-b", "repo-c"],
        )
...
class TestConfirmationService:
    ...
    def test_mixed_results(self) -> None:
        ...
        responses = [
            json.dumps({"status": "REQUIRED", "confidence": 0.9, "reason": "r1", "plan_summary": "p1", "missing_dependencies": []}),
            json.dumps({"status": "EXCLUDED", "confidence": 0.95, "reason": "r2", "plan_summary": "", "missing_dependencies": []}),
        ]
        call_count = [0]
        ...
        service = ConfirmationService(_MultiLLM(), {
            "ts-a-service": p1, "ts-b-service": p2,
        })
    ...
    def test_progress_callback(self) -> None:
        llm = _FakeLLM(json.dumps({
            "status": "REQUIRED", "confidence": 0.9, "reason": "r", "plan_summary": "p", "missing_dependencies": [],
        }))
